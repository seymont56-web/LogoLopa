...
<body>
        ...
        <div class="landing-grid">
          ...
          <div class="landing-how-cards">
            ...
            <article class="landing-how-card">
              ...
              <img class="landing-how-card__pic landing-how-card__pic--gamepad" src="assets/img/landing/gamepad.png" alt="">
            </article>
  ...
  <script>
    ...
    function getMobileHeaderHeight() {
      ...
      return header.offsetHeight + bottom;
    }
    ...
    function scrollToLandingSection(hash) {
      ...
      if (isMobile) {
        ...
        if (hash === '#lopa') {
          targetTop = sectionTop - ((viewportHeight - sectionHeight) / 2);
        }

        if (hash === '#how') {
          targetTop = sectionTop - viewportHeight + sectionHeight + mobileHeaderHeight + 18;
        }
      } else {
        targetTop = sectionTop - 110;
      }
    ...
    document.addEventListener('click', function (event) {
      const navLink = event.target.closest('.login-nav a[href^="#"]');
