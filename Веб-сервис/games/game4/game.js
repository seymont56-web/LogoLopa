(function () {
  ...
  function buildCards() {
    ...
    shuffle(PAIR_LETTERS).forEach(letter => {
  ...
  function clearDropHints() {
    document.querySelectorAll('.token--bottom.drop-ok, .token--bottom.drop-bad').forEach(el => {
  ...
  async function finishGame() {
    ...
    document.querySelectorAll('.letter-token').forEach(card => {
