...
<body>
    ...
    <div class="modal-box">
      ...
      <form class="modal-form" method="post">
        ...
        <div class="password-field">
          <input id="resetStudentPassword" type="password" name="new_password" placeholder="Новый временный пароль"
            autocomplete="new-password">

          <button class="password-icon-btn" type="button" onclick="togglePasswordVisibility('resetStudentPassword')"
            aria-label="Показать или скрыть пароль" title="Показать или скрыть пароль">
            <img src="../assets/img/eye.svg" alt="">
          </button>

          <button class="password-icon-btn" type="button" onclick="copyPasswordFromInput('resetStudentPassword')"
            aria-label="Скопировать пароль" title="Скопировать пароль">
  ...
  <div class="modal <?= $newPassword ? 'is-open' : '' ?>" id="newPasswordModal">
    <div class="modal-box">
      ...
      <div class="password-field temp-password-field">
        <input id="generatedStudentPassword" type="password" value="<?= h($newPassword) ?>" readonly>

        <button class="password-icon-btn" type="button" onclick="togglePasswordVisibility('generatedStudentPassword')"
          aria-label="Показать или скрыть пароль" title="Показать или скрыть пароль">
          <img src="../assets/img/eye.svg" alt="">
        </button>

        <button class="password-icon-btn" type="button" onclick="copyPasswordFromInput('generatedStudentPassword')"
          aria-label="Скопировать пароль" title="Скопировать пароль">
          <img src="../assets/img/copy.svg" alt="">
        </button>
      </div>
